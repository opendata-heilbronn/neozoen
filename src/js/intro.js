    ...
    angular.module('app').controller('IntroCtrl', function ($scope) {
        $scope.chartConfig = {
            ...
            series: [
                {
                    name: 'Pflanzen',
                    data: [1477, 1564, 1704, 1829, 1883, 1998, 2148, 2245, 2353, 2453, 2487]
                },
                {
                    name: 'Wirbelose Tiere',
                    data: [92, 110, 193, 229, 262, 422, 491, 605, 783, 1009, 1039]
                },
                {
                    name: 'Wirbeltiere',
                    data: [63, 65, 76, 87, 90, 105, 121, 134, 161, 247, 251]
                }
            ],
            loading: false,
            xAxis: {
